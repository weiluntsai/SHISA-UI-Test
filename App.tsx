      ...
      >
        ...
        <div className="h-14 flex items-center justify-between px-4 border-b border-gray-800 bg-[#0f0f0f] shrink-0">
          <div className="flex items-center overflow-hidden">
            ...
            <span className="ml-3 font-bold text-lg tracking-tight text-white whitespace-nowrap">SHISA.IO</span>
          </div>
        ...
        <div className="flex-1 py-4 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-gray-800">
          <div className="px-4 mb-2 text-xs font-semibold text-gray-600 uppercase tracking-wider">{t.monitor}</div>
          ...
          <div className="px-4 mt-6 mb-2 text-xs font-semibold text-gray-600 uppercase tracking-wider">{t.system}</div>
